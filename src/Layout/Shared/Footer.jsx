...
function Footer() {
  ...
  <div>
    <img src="https://cdn.pixabay.com/photo/2016/07/13/16/00/box-1514845_640.jpg" className='h-[50px] w-[50px] rounded-full' alt="" />
    <p>Sport Ground<br/>Find your best Sports</p>
  </div> 
  <div>
